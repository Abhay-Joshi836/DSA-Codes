...
5) Stuart came up with a Stack problem! He first learns about stacks. Stack is a basic data structure where 3 operations can be done:
...
inc 2 1: 2 3 3 4
Input Format
First line indicates number of elements in stack.
Second line indicates numbers of elements to be popped from stack.
Third line indicates the value of k.
Fourth line indicates the value of v.
Fifth line indicates the elements of stack.
Constraints
Use only integers.
Output Format
