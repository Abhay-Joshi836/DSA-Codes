/*
6) One of the utility bill payments company wants to build a mobile recharge application for end users. The application should support all the network providers available in the market. The flow is, the user sends SMS in predefined format and application should parse the message and do the recharge accordingly.
...
Sample Input 1
3
9870654241 499 postpaid
7896504531 250 postpaid
9845648342 399 postpaid
Sample Output 1
Postpaid Requests
9870654241 499 postpaid
7896504531 250 postpaid
...
Sample Input 2
2
9867654651 399 prepaid
8970650053 598 prepaid
Sample Output 2
Postpaid Requests
Queue Empty
0
